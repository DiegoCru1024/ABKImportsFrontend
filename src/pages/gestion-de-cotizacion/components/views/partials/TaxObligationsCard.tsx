...
export default function TaxObligationsCard({
  ...
  const taxItems = [
    ...
    ...(isMaritime ? [{
      ...
      value: values.percepcion ? (values.totalDerechosDolares - values.adValorem - values.igvFiscal - values.ipm) : (values.totalDerechosDolares - values.adValorem - values.igvFiscal - values.ipm),
      ...
      <AccordionItem value="tax-obligations" className="border-0">
        ...
        <div className="space-y-4">
          <div className="flex items-center gap-2 mb-4">
            ...
            <span className="text-sm text-gray-600">Aplicables según régimen</span>
          </div>
