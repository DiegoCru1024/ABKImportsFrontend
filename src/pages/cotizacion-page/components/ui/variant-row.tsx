...
export const VariantRow = ({
  ...
  useEffect(() => {
    ...
    console.log(
      "Valor de variant.file",
      JSON.stringify(selectedFiles, null, 2), selectedFiles
    );
    console.log("Valor de variant.urls", JSON.stringify(existingUrls, null, 2), existingUrls);
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
        ...
        <div className="col-span-1">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
            ...
            <div>
              <Label
                htmlFor={`presentation-${variant.id}`}
                className="text-sm font-medium text-gray-700 dark:text-gray-300"
              >
                Presentación
              </Label>
              <Input
                ...
                onChange={(e) =>
                  onUpdate(variant.id, "presentation", e.target.value)
                }
                className="mt-1"
              />
            </div>
        ...
        <div className="col-span-2 space-y-4 relative py-2">
          {canDelete ? (
