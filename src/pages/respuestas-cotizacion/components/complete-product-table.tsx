...
interface CompleteProductTableProps {
  product: CompleteProductInterface;
  index: number;
  quotationDetail?: any;
}

export function CompleteProductTable({ product, index, quotationDetail }: CompleteProductTableProps) {
  ...
  return (
    <div className="bg-white border border-gray-200 rounded-lg overflow-hidden">
      <div className="grid grid-cols-7 gap-4 p-4 bg-gray-50 border-b border-gray-200 text-sm font-semibold text-gray-700">
      ...
      <div className="grid grid-cols-7 gap-4 p-4 items-start">
        ...
        <div className="grid grid-cols-2 gap-2 text-xs">
          <div>
            ...
            <p className="font-semibold text-green-600">{formatCurrency(product.pricing?.totalCost || 0)}</p>
          </div>
          <div>
            <label className="block text-gray-600 mb-1">Equivalencia</label>
            <p className="font-medium text-blue-600">{product.pricing?.equivalence?.toFixed(2) || '0.00'}%</p>
          </div>
        </div>

        <div className="grid grid-cols-1 gap-2 text-xs">
          <div>
            <label className="block text-gray-600 mb-1">Gastos Importación</label>
            <p className="font-semibold text-orange-600">{formatCurrency(product.pricing?.importCosts || 0)}</p>
          </div>
        </div>

        <div className="text-center">
          <div className="text-xs text-gray-600 mb-1">USD</div>
          <div className="text-lg font-semibold text-purple-600 border border-purple-200 rounded px-2 py-1 bg-purple-50">
        ...
        <div className="bg-gray-50 border-t border-gray-200">
          <div className="p-4">
            ...
            <div className="bg-white rounded-lg border border-gray-200 overflow-hidden">
              <div className="grid grid-cols-7 gap-4 p-3 bg-gray-100 border-b border-gray-200 text-sm font-semibold text-gray-700">
                ...
                <div className="text-purple-600">Costo unitario</div>
              </div>
                ...
                {product.variants.map((variant) => {
                  ...
                  return (
                    <div
                      ...
                      className="grid grid-cols-7 gap-4 p-3 items-center text-sm"
                    >
                      <div className="flex justify-center">
                        {variant.isQuoted ? (
                          <Badge variant="default" className="bg-green-100 text-green-800 text-xs">
